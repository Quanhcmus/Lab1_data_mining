...
if __name__ == "__main__":
   ...
   parser.add_argument('--out', dest='out_file', default='output/impute.csv', help='path to output CSV file')
   args = parser.parse_args()
   args = parser.parse_args()
   list_fmv_cols = impute(args.data_file,args.method,args.columns,args.out_file)
   print(list_fmv_cols.fillMissingValues())
   list_fmv_cols.writeFile()
